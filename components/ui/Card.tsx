...
export default function Card({
  ...
  const cardStyles = cn(
    "group h-full flex flex-col p-6 rounded-2xl bg-[var(--theme-surface)] border border-transparent",
  ...
  if (href) {
    return (
      <Link href={href} className={cardStyles}>
        ...
        <div className="mt-4 pt-4 border-t border-[var(--theme-text)]/5 flex items-center text-[var(--theme-accent)] font-medium opacity-0 group-hover:opacity-100 transition-opacity">
          En savoir plus
          <svg
